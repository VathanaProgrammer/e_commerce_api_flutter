            ...
            <div class="row g-3 align-items-start">
                ...
                <div class="col-md-9">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label>Email</label>
                            <input name="email" type="email" class="form-control form-control-sm rounded-0" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="password" type="password" class="form-control form-control-sm rounded-0" required>
                        </div>
