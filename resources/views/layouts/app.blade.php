        ...
        <nav class="navbar navbar-expand-lg navbar-light sed p-3 overflow-hidden">
            <div class="container-fluid d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center me-3">
                    <a href="{{ route('home') }}" class="text-white text-decoration-none fw-bold" style="outline: none;">
                ...
                <ul class="navbar-nav ms-auto d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown me-3 thr text-white rounded px-2 py-1 d-flex align-items-center" style="height: 45px;">
                        <a class="nav-link dropdown-toggle text-dark text-white" href="#" role="button" data-bs-toggle="dropdown">
                    ...
                    <li class="nav-item thr text-white px-3 py-1 rounded d-flex align-items-center" style="height: 45px;">
...
$(document).one('click keydown scroll', () => { soundEnabled = true; });
